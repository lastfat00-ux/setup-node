...
const findLockFile = (packageManager: PackageManagerInfo) => {
  ...
  // Performance optimization: check existence of lock files directly using fs.existsSync
  // instead of allocating memory and scanning all workspace directory entries with fs.readdirSync.
