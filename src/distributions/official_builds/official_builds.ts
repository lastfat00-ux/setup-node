...
export default class OfficialBuilds extends BaseDistribution {
  ...
  private resolveLtsAliasFromManifest(
    ...
    // Single-pass reverse loop over the manifest with a Map to map LTS aliases in O(N) time
    // without allocating multiple intermediate arrays (filter, map, reverse) or pair objects.
