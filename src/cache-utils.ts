...
const commandOutputMemoized = new Map<string, string>();

/**
 * unit test must reset memoized variables
 */
export const resetCommandOutputCache = () => commandOutputMemoized.clear();
...
export const getCommandOutput = async (
  ...
  if (commandOutputMemoized.has(cacheKey)) {
    return commandOutputMemoized.get(cacheKey)!;
  }
  ...
  commandOutputMemoized.set(cacheKey, result);
  return result;
};
