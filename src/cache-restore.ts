...
const findLockFile = (packageManager: PackageManagerInfo) => {
  ...
  // Optimization: check file existence directly using fs.existsSync instead of reading all directory entries
  // via fs.readdirSync(workspace). In large repositories, listing every file in workspace can be expensive and allocates unnecessary arrays.
