...
const findLockFile = (packageManager: PackageManagerInfo) => {
  ...
  // Optimization: Check for lock file existence directly via fs.existsSync rather than
  // readdirSync(workspace) which reads/allocates all entries in large workspace directories.
