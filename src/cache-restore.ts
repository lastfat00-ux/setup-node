...
const findLockFile = (packageManager: PackageManagerInfo) => {
  ...
  // Optimization: check existence of candidate lock files directly using fs.existsSync
  // instead of scanning and allocating array memory for all directory entries via fs.readdirSync.
