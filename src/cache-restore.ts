...
const findLockFile = (packageManager: PackageManagerInfo) => {
  ...
  // Optimization: Check for lock file existence directly using fs.existsSync
  // instead of reading and allocating all workspace directory entries with fs.readdirSync
