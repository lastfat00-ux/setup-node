...
export default class OfficialBuilds extends BaseDistribution {
  ...
  private resolveLtsAliasFromManifest(
    ...
    // Single-pass reverse iteration over manifest to build LTS aliases map in O(N) time
    // without creating multiple intermediate arrays (filter, map, reverse) or intermediate pair objects.
